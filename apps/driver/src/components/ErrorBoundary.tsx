  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <p className="mt-2 text-sm text-text-secondary dark:text-gris-senal">
        ...
        <div className="mt-4 flex justify-center gap-2">
          ...
          <button
            ...
            className="rounded-lg border border-border dark:border-white/10 px-4 py-2 text-sm font-semibold text-text-secondary dark:text-gris-senal"
          >
            Recargar
          </button>
        </div>
