 ...
 * (motos, carro, van eléctrica), pedidos contra-entrega y todos los módulos
...
async function main() {
  ...
  const orders: Array<{
    ...
    { customerName: "Laura Martínez", customerPhone: "+573101000001", addressRaw: "Cra 13 # 54-20, Chapinero", lat: 4.6416, lng: -74.0639, paymentType: "COD", codAmount: 89000, weightKg: 2 },
    ...
    { customerName: "Sofía Torres", customerPhone: "+573101000003", addressRaw: "Cl 116 # 15-08, Santa Bárbara", lat: 4.6957, lng: -74.0395, paymentType: "COD", codAmount: 156000, weightKg: 3.4 },
    ...
    { customerName: "Camila Vargas", customerPhone: "+573101000005", addressRaw: "Frente al colegio San Bartolomé, La Candelaria", addressNotes: "Casa de portón verde, preguntar por la señora Camila", lat: 4.5972, lng: -74.0736, paymentType: "COD", codAmount: 45000, weightKg: 1.5 },
    { customerName: "Felipe Castro", customerPhone: "+573101000006", addressRaw: "Cl 26 # 68-35, Salitre", lat: 4.6486, lng: -74.0995, weightKg: 5.0 },
    { customerName: "Valentina López", customerPhone: "+573101000007", addressRaw: "Cra 15 # 93-60, Chicó", lat: 4.6766, lng: -74.0488, paymentType: "COD", codAmount: 210000, weightKg: 2.2, priority: 5 },
    { customerName: "Jorge Ramírez", customerPhone: "+573101000008", addressRaw: "Av Suba # 116-20, Suba", lat: 4.7196, lng: -74.0716, weightKg: 4.1 },
    { customerName: "Daniela Moreno", customerPhone: "+573101000009", addressRaw: "Cl 147 # 19-50, Cedritos", lat: 4.7266, lng: -74.0387, paymentType: "COD", codAmount: 67500, weightKg: 1.0 },
    ...
    { customerName: "Paula Jiménez", customerPhone: "+573101000011", addressRaw: "Cl 63 # 28-10, Siete de Agosto", lat: 4.6553, lng: -74.0782, paymentType: "COD", codAmount: 120000, weightKg: 2.7 },
